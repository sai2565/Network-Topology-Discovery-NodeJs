...
const E = configureMachine({ "name": "E", "ip": "9004", "neighbours": [9000, 9003] });

const F = configureMachine({ "name": "F", "ip": "9005", "neighbours": [9006] });
...
const N = configureMachine({ "name": "N", "ip": "9013", "neighbours": [9012] });
